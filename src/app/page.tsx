...
// ─── Translations (EN + PT) — Bruno Paulon's exact LinkedIn profile ──
const translations = {
  en: {
    ...
    stack2: 'ERP/CRM · REST · GraphQL · TypeScript',
    stack3: 'Building scalable, high-impact solutions',
    stack4: 'for enterprise systems and international clients.',
    projects: 'Projects',
    about: 'About',
    contact: 'Contact',
    ...
    project3Desc: 'Next-generation ERP system for Portugal and Angola featuring invoicing, accounting, and business management — built with TypeScript and a modular architecture. Integrated with PHC and SAP systems for enterprise synchronization.',
    project4Title: 'Digital Detox App',
    project4Desc: 'A PWA combating digital addiction using the MERN stack with React, Material UI, Express, MongoDB, and ChatGPT API integration for smart behavior insights and AI-powered workflow automation.',
    ...
    aboutTitle: 'About Me',
    aboutText1: "I'm a Full Stack Developer with 5+ years of experience developing scalable, high-impact solutions for enterprise systems, web applications, and international clients. I have advanced expertise in Node.js, React, and Fastify. My experience includes architecting high-performance RESTful APIs, building responsive front-end applications, and implementing complex ERP/CRM integrations (PHC, SAP, Salesforce) that process thousands of transactions daily.",
    aboutText2: "I also work with TypeScript, Angular, MongoDB, PostgreSQL, C#, and AI integrations (ChatGPT API) for workflow automation and intelligent systems. At Acidados SA and as a freelancer on Workana, I reduced API response time by 45% through modern architecture migration, built automated POS-to-ERP synchronization systems processing 5,000+ daily transactions with 99.9% accuracy, and delivered 20+ successful projects including e-commerce platforms, custom dashboards, and SPAs for international clients with 5-star ratings.",
    aboutText3: "I'm open to global remote opportunities as a Full Stack Developer, especially in high-performance environments where I can apply my expertise in Node.js, React, enterprise integrations, and modern architectures.",
    contactTitle: 'Get In Touch',
    contactText: "Looking for a Full Stack Developer who delivers measurable business impact? Let's talk. I'm open to global remote opportunities, especially in high-performance environments.",
    viewProject: 'View Project',
    techStack: 'Tech Stack',
    skills: 'Skills',
    footerText: 'Designed & Built by Bruno Paulon',
    designCredit: 'Design by',
    terminalLine: '> building high-impact solutions_',
  },
  pt: {
    ...
    stack1: 'Node.js · React · Fastify · MongoDB',
    stack2: 'ERP/CRM · REST · GraphQL · TypeScript',
    stack3: 'Construindo soluções escaláveis e de alto impacto',
    stack4: 'para sistemas empresariais e clientes internacionais.',
    projects: 'Projetos',
    about: 'Sobre',
    contact: 'Contato',
    ...
    project3Title: 'ERP NextGen',
    project3Desc: 'Sistema ERP de nova geração para Portugal e Angola com faturação, contabilidade e gestão empresarial — construído com TypeScript e arquitetura modular. Integrado com sistemas PHC e SAP para sincronização empresarial.',
    project4Title: 'Digital Detox App',
    project4Desc: 'PWA de combate ao vício digital usando MERN Stack com React, Material UI, Express, MongoDB e integração ChatGPT API para insights inteligentes de comportamento e automação de fluxos com IA.',
    project5Title: 'DocScanNode (OCR Studio)',
    project5Desc: 'Ferramenta inteligente de extração de documentos com Google Cloud Vision API. Automatiza a extração de dados de faturas com OCR, upload de imagens e processamento estruturado para fluxos de trabalho otimizados.',
    project6Title: 'BrawlTracker PWA',
    ...
    aboutText1: 'Sou um Desenvolvedor Full Stack com mais de 5 anos de experiência desenvolvendo soluções escaláveis e de alto impacto para sistemas empresariais, aplicações web e clientes internacionais. Tenho expertise avançada em Node.js, React e Fastify. Minha experiência inclui arquitetar APIs RESTful de alta performance, construir aplicações front-end responsivas e implementar integrações complexas de ERP/CRM (PHC, SAP, Salesforce) que processam milhares de transações diariamente.',
    aboutText2: 'Também trabalho com TypeScript, Angular, MongoDB, PostgreSQL, C# e integrações de IA (ChatGPT API) para automação de fluxos e sistemas inteligentes. Na Acidados SA e como freelancer na Workana, reduzi o tempo de resposta de API em 45% através de migração de arquitetura moderna, construí sistemas de sincronização POS-to-ERP automatizados processando 5.000+ transações diárias com 99,9% de precisão, e entreguei 20+ projetos de sucesso incluindo plataformas de e-commerce, dashboards personalizados e SPAs para clientes internacionais com avaliações 5 estrelas.',
    aboutText3: 'Estou aberto a oportunidades remotas globais como Desenvolvedor Full Stack, especialmente em ambientes de alta performance onde posso aplicar minha expertise em Node.js, React, integrações empresariais e arquiteturas modernas.',
    contactTitle: 'Entre Em Contato',
    contactText: 'Procurando um Desenvolvedor Full Stack que entrega impacto de negócio mensurável? Vamos conversar. Estou aberto a oportunidades remotas globais, especialmente em ambientes de alta performance.',
    viewProject: 'Ver Projeto',
    techStack: 'Stack Tecnológica',
    skills: 'Habilidades',
    footerText: 'Desenvolvido por Bruno Paulon',
    designCredit: 'Design por',
    terminalLine: '> construindo soluções de alto impacto_',
  },
}
...
const projects = [
  ...
  { image: '/project3.png', tech: ['TypeScript', 'Next.js', 'ERP', 'PHC/SAP'], github: 'https://github.com/bfrpaulondev/erp-nextgen', live: '#' },
  { image: '/project4.png', tech: ['React', 'Material UI', 'ChatGPT API', 'MERN'], github: 'https://github.com/bfrpaulondev/digital-detox-app', live: 'https://digital-detox-app-sigma.vercel.app' },
...
// ─── Skill categories (exact hard skills from LinkedIn) ──────────
const skillCategories = [
  { icon: Code2, labelEn: 'Frontend', labelPt: 'Frontend', items: ['React', 'Angular', 'Next.js', 'TypeScript', 'Material UI'] },
  { icon: Server, labelEn: 'Backend', labelPt: 'Backend', items: ['Node.js', 'Fastify', 'Express', 'C# / .NET', 'ChatGPT API'] },
  { icon: Database, labelEn: 'Database & APIs', labelPt: 'Banco de Dados & APIs', items: ['MongoDB', 'PostgreSQL', 'REST APIs', 'GraphQL', 'SQL'] },
  { icon: Globe, labelEn: 'ERP/CRM Integration', labelPt: 'Integração ERP/CRM', items: ['PHC', 'SAP', 'Salesforce', 'E-commerce', 'POS Sync'] },
  { icon: Cpu, labelEn: 'Practices & Tools', labelPt: 'Práticas & Ferramentas', items: ['Docker', 'Git/GitHub', 'SOLID / Clean Code', 'Scrum / Kanban', 'Legacy Modernization'] },
]
